...
agregarSimboloExclamacion("Soy Henry");
...
combinarNombres("Silvia", "Pérez");

function obtenerSaludo(nombre) {
  // Toma la string "nombre" y concatena otras string en la cadena para que tome la siguiente forma:
  // "Martin" -> "Hola Martin!"
  // Tu código:
  let obtenerSaludo = nombre;
  return "Hola " + nombre + "!"; 
  
}
obtenerSaludo("Julián");
